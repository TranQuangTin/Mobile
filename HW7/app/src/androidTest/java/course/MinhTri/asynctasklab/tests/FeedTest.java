package course.MinhTri.asynctasklab.tests;
...
import course.MinhTri.asynctasklab.MainActivity;
...
public class FeedTest extends ActivityInstrumentationTestCase2<MainActivity> {
	...
	public void testRun() {
		...
		// Wait for activity:
		// 'course.MinhTri.threadslab.TestFrontEndActivity'
		solo.waitForActivity(course.MinhTri.asynctasklab.MainActivity.class,
				shortDelay);
		...
		assertTrue("feed_view not shown!", solo.waitForView(solo
				.getView(course.MinhTri.asynctasklab.R.id.feed_view)));
