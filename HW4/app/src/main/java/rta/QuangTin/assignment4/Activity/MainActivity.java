package rta.QuangTin.assignment4.Activity;
...
import rta.QuangTin.assignment4.Instance.Cookie;
import rta.QuangTin.assignment4.R;
        ...
        timer = new CountDownTimer(121000, 1000) {
            ...
            public void onFinish() {
                ...
                if (monster1.amount > monster2.amount) {
                    Toast.makeText(MainActivity.this, "Monter 1 Win"+monster1.amount+"/"+monster2.amount+"!", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(MainActivity.this, "Monter 2 Win"+monster2.amount+"/"+monster1.amount+"!", Toast.LENGTH_SHORT).show();
                }
