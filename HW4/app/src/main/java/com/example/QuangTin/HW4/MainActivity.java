package com.example.QuangTin.HW4;
...
public class MainActivity extends AppCompatActivity {
        ...
        public void run() {
            ...
            while (go == true){
                synchronized (vcookie){
                    int tmp=vcookie.takeCookie();
                    amount = amount + tmp;
                    if(threadName == "monter 1"){
                        new job1().execute(tmp);
                    }else {
                        new job2().execute(tmp);
                    }
                }
                int max = 5;
                int min = 1;
    ...
    class job1 extends AsyncTask<Integer,String,Integer>{
        ...
        protected void onPostExecute(Integer result) {
            ...
            try{
                tv1.setText(String.valueOf(result)+"/"+ String.valueOf(result+ Integer.parseInt(((String) tv1.getText()).split("/")[1] ) ));
                progressBar1.setProgress(Integer.parseInt(((String) tv1.getText()).split("/")[1] ));
            }
            catch(java.lang.Exception e) {
                    tv1.setText(String.valueOf(result)+"/"+ String.valueOf(0));
    ...
    class job2 extends AsyncTask<Integer,String,Integer>{
        ...
        protected void onPostExecute(Integer result) {
            super.onPostExecute(result);
            try{
                tv2.setText(String.valueOf(result)+"/"+ String.valueOf(result+ Integer.parseInt(((String) tv2.getText()).split("/")[1] )));

                progressBar2.setProgress(Integer.parseInt(((String) tv2.getText()).split("/")[1] ));}
            catch(java.lang.Exception e) {
                tv2.setText(String.valueOf(result)+"/"+ String.valueOf(0));
